...
import { deleteClass } from "@/features/classes/actions/delete-class-action";
                  ...
                  >
                    ...
                    <div className="flex items-center gap-3 mb-4">
                      ...
                      <button
                        ...
                        className="p-2 rounded-lg bg-red-50 hover:bg-red-100 text-red-600 hover:text-red-700 transition-all duration-200 opacity-0 group-hover:opacity-100 disabled:opacity-50 disabled:cursor-not-allowed"
                        title="Delete class"
                      >
