...
import type {
  ...
  RemoveRoute,
  UpdateRoute,
} from "./postComment.routes";

// 🔍 List all postComments
...
export const getOne: AppRouteHandler<GetByIdRoute> = async (c) => {
  ...
  const postComment = await db.query.postComments.findFirst({
  ...
  return c.json(postComment, HttpStatusCodes.OK);
};
